...
{name:'American Samoa', iso2:'AS', iso3:'ASM', latitude:'-14.3333', longitude:'-170', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Anguilla', iso2:'AI', iso3:'AIA', latitude:'18.25', longitude:'-63.1667', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Aruba', iso2:'AW', iso3:'ABW', latitude:'12.5', longitude:'-69.9667', created_at: moment().format(), updated_at: moment().format() },
{name:'Australia', iso2:'AU', iso3:'AUS', latitude:'-27', longitude:'133', created_at: moment().format(), updated_at: moment().format() },
{name:'Austria', iso2:'AT', iso3:'AUT', latitude:'47.3333', longitude:'13.3333', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Barbados', iso2:'BB', iso3:'BRB', latitude:'13.1667', longitude:'-59.5333', created_at: moment().format(), updated_at: moment().format() },
{name:'Belarus', iso2:'BY', iso3:'BLR', latitude:'53', longitude:'28', created_at: moment().format(), updated_at: moment().format() },
{name:'Belgium', iso2:'BE', iso3:'BEL', latitude:'50.8333', longitude:'4', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Bermuda', iso2:'BM', iso3:'BMU', latitude:'32.3333', longitude:'-64.75', created_at: moment().format(), updated_at: moment().format() },
{name:'Bhutan', iso2:'BT', iso3:'BTN', latitude:'27.5', longitude:'90.5', created_at: moment().format(), updated_at: moment().format() },
{name:'Bolivia; Plurinational State of', iso2:'BO', iso3:'BOL', latitude:'-17', longitude:'-65', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Bouvet Island', iso2:'BV', iso3:'BVT', latitude:'-54.4333', longitude:'3.4', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Brunei Darussalam', iso2:'BN', iso3:'BRN', latitude:'4.5', longitude:'114.6667', created_at: moment().format(), updated_at: moment().format() },
{name:'Brunei', iso2:'BN', iso3:'BRN', latitude:'4.5', longitude:'114.6667', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Christmas Island', iso2:'CX', iso3:'CXR', latitude:'-10.5', longitude:'105.6667', created_at: moment().format(), updated_at: moment().format() },
{name:'Cocos (Keeling) Islands', iso2:'CC', iso3:'CCK', latitude:'-12.5', longitude:'96.8333', created_at: moment().format(), updated_at: moment().format() },
{name:'Colombia', iso2:'CO', iso3:'COL', latitude:'4', longitude:'-72', created_at: moment().format(), updated_at: moment().format() },
{name:'Comoros', iso2:'KM', iso3:'COM', latitude:'-12.1667', longitude:'44.25', created_at: moment().format(), updated_at: moment().format() },
{name:'Congo', iso2:'CG', iso3:'COG', latitude:'-1', longitude:'15', created_at: moment().format(), updated_at: moment().format() },
{name:'Congo; the Democratic Republic of the', iso2:'CD', iso3:'COD', latitude:'0', longitude:'25', created_at: moment().format(), updated_at: moment().format() },
{name:'Cook Islands', iso2:'CK', iso3:'COK', latitude:'-21.2333', longitude:'-159.7667', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Croatia', iso2:'HR', iso3:'HRV', latitude:'45.1667', longitude:'15.5', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Dominica', iso2:'DM', iso3:'DMA', latitude:'15.4167', longitude:'-61.3333', created_at: moment().format(), updated_at: moment().format() },
{name:'Dominican Republic', iso2:'DO', iso3:'DOM', latitude:'19', longitude:'-70.6667', created_at: moment().format(), updated_at: moment().format() },
...
{name:'El Salvador', iso2:'SV', iso3:'SLV', latitude:'13.8333', longitude:'-88.9167', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Gambia', iso2:'GM', iso3:'GMB', latitude:'13.4667', longitude:'-16.5667', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Gibraltar', iso2:'GI', iso3:'GIB', latitude:'36.1833', longitude:'-5.3667', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Grenada', iso2:'GD', iso3:'GRD', latitude:'12.1167', longitude:'-61.6667', created_at: moment().format(), updated_at: moment().format() },
{name:'Guadeloupe', iso2:'GP', iso3:'GLP', latitude:'16.25', longitude:'-61.5833', created_at: moment().format(), updated_at: moment().format() },
{name:'Guam', iso2:'GU', iso3:'GUM', latitude:'13.4667', longitude:'144.7833', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Haiti', iso2:'HT', iso3:'HTI', latitude:'19', longitude:'-72.4167', created_at: moment().format(), updated_at: moment().format() },
{name:'Heard Island and McDonald Islands', iso2:'HM', iso3:'HMD', latitude:'-53.1', longitude:'72.5167', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Hong Kong', iso2:'HK', iso3:'HKG', latitude:'22.25', longitude:'114.1667', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Iran; Islamic Republic of', iso2:'IR', iso3:'IRN', latitude:'32', longitude:'53', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Italy', iso2:'IT', iso3:'ITA', latitude:'42.8333', longitude:'12.8333', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Kiribati', iso2:'KI', iso3:'KIR', latitude:'1.4167', longitude:'173', created_at: moment().format(), updated_at: moment().format() },
{name:'Korea; Republic of', iso2:'KR', iso3:'KOR', latitude:'37', longitude:'127.5', created_at: moment().format(), updated_at: moment().format() },
{name:'South Korea', iso2:'KR', iso3:'KOR', latitude:'37', longitude:'127.5', created_at: moment().format(), updated_at: moment().format() },
{name:'Kuwait', iso2:'KW', iso3:'KWT', latitude:'29.3375', longitude:'47.6581', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Lebanon', iso2:'LB', iso3:'LBN', latitude:'33.8333', longitude:'35.8333', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Liechtenstein', iso2:'LI', iso3:'LIE', latitude:'47.1667', longitude:'9.5333', created_at: moment().format(), updated_at: moment().format() },
{name:'Lithuania', iso2:'LT', iso3:'LTU', latitude:'56', longitude:'24', created_at: moment().format(), updated_at: moment().format() },
{name:'Luxembourg', iso2:'LU', iso3:'LUX', latitude:'49.75', longitude:'6.1667', created_at: moment().format(), updated_at: moment().format() },
{name:'Macao', iso2:'MO', iso3:'MAC', latitude:'22.1667', longitude:'113.55', created_at: moment().format(), updated_at: moment().format() },
{name:'Macedonia; the former Yugoslav Republic of', iso2:'MK', iso3:'MKD', latitude:'41.8333', longitude:'22', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Malta', iso2:'MT', iso3:'MLT', latitude:'35.8333', longitude:'14.5833', created_at: moment().format(), updated_at: moment().format() },
{name:'Marshall Islands', iso2:'MH', iso3:'MHL', latitude:'9', longitude:'168', created_at: moment().format(), updated_at: moment().format() },
{name:'Martinique', iso2:'MQ', iso3:'MTQ', latitude:'14.6667', longitude:'-61', created_at: moment().format(), updated_at: moment().format() },
{name:'Mauritania', iso2:'MR', iso3:'MRT', latitude:'20', longitude:'-12', created_at: moment().format(), updated_at: moment().format() },
{name:'Mauritius', iso2:'MU', iso3:'MUS', latitude:'-20.2833', longitude:'57.55', created_at: moment().format(), updated_at: moment().format() },
{name:'Mayotte', iso2:'YT', iso3:'MYT', latitude:'-12.8333', longitude:'45.1667', created_at: moment().format(), updated_at: moment().format() },
{name:'Mexico', iso2:'MX', iso3:'MEX', latitude:'23', longitude:'-102', created_at: moment().format(), updated_at: moment().format() },
{name:'Micronesia; Federated States of', iso2:'FM', iso3:'FSM', latitude:'6.9167', longitude:'158.25', created_at: moment().format(), updated_at: moment().format() },
{name:'Moldova; Republic of', iso2:'MD', iso3:'MDA', latitude:'47', longitude:'29', created_at: moment().format(), updated_at: moment().format() },
{name:'Monaco', iso2:'MC', iso3:'MCO', latitude:'43.7333', longitude:'7.4', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Nauru', iso2:'NR', iso3:'NRU', latitude:'-0.5333', longitude:'166.9167', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Niue', iso2:'NU', iso3:'NIU', latitude:'-19.0333', longitude:'-169.8667', created_at: moment().format(), updated_at: moment().format() },
{name:'Norfolk Island', iso2:'NF', iso3:'NFK', latitude:'-29.0333', longitude:'167.95', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Palestinian Territory; Occupied', iso2:'PS', iso3:'PSE', latitude:'32', longitude:'35.25', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Réunion', iso2:'RE', iso3:'REU', latitude:'-21.1', longitude:'55.6', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Saint Helena; Ascension and Tristan da Cunha', iso2:'SH', iso3:'SHN', latitude:'-15.9333', longitude:'-5.7', created_at: moment().format(), updated_at: moment().format() },
{name:'Saint Kitts and Nevis', iso2:'KN', iso3:'KNA', latitude:'17.3333', longitude:'-62.75', created_at: moment().format(), updated_at: moment().format() },
{name:'Saint Lucia', iso2:'LC', iso3:'LCA', latitude:'13.8833', longitude:'-61.1333', created_at: moment().format(), updated_at: moment().format() },
{name:'Saint Pierre and Miquelon', iso2:'PM', iso3:'SPM', latitude:'46.8333', longitude:'-56.3333', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Samoa', iso2:'WS', iso3:'WSM', latitude:'-13.5833', longitude:'-172.3333', created_at: moment().format(), updated_at: moment().format() },
{name:'San Marino', iso2:'SM', iso3:'SMR', latitude:'43.7667', longitude:'12.4167', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Seychelles', iso2:'SC', iso3:'SYC', latitude:'-4.5833', longitude:'55.6667', created_at: moment().format(), updated_at: moment().format() },
{name:'Sierra Leone', iso2:'SL', iso3:'SLE', latitude:'8.5', longitude:'-11.5', created_at: moment().format(), updated_at: moment().format() },
{name:'Singapore', iso2:'SG', iso3:'SGP', latitude:'1.3667', longitude:'103.8', created_at: moment().format(), updated_at: moment().format() },
{name:'Slovakia', iso2:'SK', iso3:'SVK', latitude:'48.6667', longitude:'19.5', created_at: moment().format(), updated_at: moment().format() },
...
{name:'South Sudan', iso2:'SS', iso3:'SSD', latitude:'8', longitude:'30', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Taiwan; Province of China', iso2:'TW', iso3:'TWN', latitude:'23.5', longitude:'121', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Tanzania; United Republic of', iso2:'TZ', iso3:'TZA', latitude:'-6', longitude:'35', created_at: moment().format(), updated_at: moment().format() },
{name:'Thailand', iso2:'TH', iso3:'THA', latitude:'15', longitude:'100', created_at: moment().format(), updated_at: moment().format() },
{name:'Timor-Leste', iso2:'TL', iso3:'TLS', latitude:'-8.55', longitude:'125.5167', created_at: moment().format(), updated_at: moment().format() },
{name:'Togo', iso2:'TG', iso3:'TGO', latitude:'8', longitude:'1.1667', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Turks and Caicos Islands', iso2:'TC', iso3:'TCA', latitude:'21.75', longitude:'-71.5833', created_at: moment().format(), updated_at: moment().format() },
...
{name:'United States Minor Outlying Islands', iso2:'UM', iso3:'UMI', latitude:'19.2833', longitude:'166.6', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Venezuela; Bolivarian Republic of', iso2:'VE', iso3:'VEN', latitude:'8', longitude:'-66', created_at: moment().format(), updated_at: moment().format() },
...
{name:'Virgin Islands; U,S,', iso2:'VI', iso3:'VIR', latitude:'18.3333', longitude:'-64.8333', created_at: moment().format(), updated_at: moment().format() },
...
module.exports = {
  up: queryInterface => queryInterface.bulkDelete('countries')
    .then(() => queryInterface.bulkInsert('countries', countries)),
